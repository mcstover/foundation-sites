...
module.exports = {
  ...
  vendor: {
    files: {
      ...
      '<%= paths.dist %>assets/js/vendor/jquery-migrate.js': '<%= paths.vendor %>jquery-migrate/index.js',
